...
//     function getManagementFee(address unitAddress) 
//         external 
//         view 
//         override 
//         returns (uint256) 
...
//     function getLateFee(address unitAddress) 
//         external 
//         view 
//         override 
//         onlyRegistered(unitAddress) 
//         returns (uint256) 
//     {
//         DataTypes.Unit memory unit = unitStorage.getUnit(unitAddress);
...
//     function registerUnit(address unitAddress) external override {
...
//     function updateVotingRights(address unitAddress, bool status) 
//         external 
//         override 
//         onlyRegistered(unitAddress) 
//     {
...
//         uint256 change, 
//         bool increase
//     ) external override onlyRegistered(unitAddress) {
//         DataTypes.Unit memory unit = unitStorage.getUnit(unitAddress);
//         uint256 newQuota = increase ? 
//             unit.bookingQuota + change : 
//             unit.bookingQuota > change ? unit.bookingQuota - change : 0;
